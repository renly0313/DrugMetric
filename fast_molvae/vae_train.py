...
def main_vae_train(train,
    ...
    with open(os.path.join(save_data, 'mix_rand1_total_mean_std.pkl'), 'wb') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', type=str, default="../data/datasets/chembl/new_sample/chembl_rand4_processed")
    parser.add_argument('--vocab', type=str, default="../data/vocab/all_data_vocab.txt")
    parser.add_argument('--save_dir', type=str, default="../data/save_model/mix_rand1_model")
    parser.add_argument('--save_data', type=str, default="../data/latent_space_result/mix_rand1")
